...
class BlackNode extends QuadTreeNode
{
  ...
  {
    super(quadrant,  null, null, null, null, parent);
  }
  ...
  public int perimeter(int size)
  {
    ...
    if (neighbor == null || neighbor instanceof WhiteNode)
      ...
      retval += neighbor.sumAdjacent(QuadrantFields.cSouthEast, QuadrantFields.cSouthWest, size);
    ...
    if (neighbor == null || neighbor instanceof WhiteNode)
      ...
      retval += neighbor.sumAdjacent(QuadrantFields.cSouthWest, QuadrantFields.cNorthWest, size);
    ...
    if (neighbor == null || neighbor instanceof WhiteNode)
      ...
      retval += neighbor.sumAdjacent(QuadrantFields.cNorthWest, QuadrantFields.cNorthEast, size);
    ...
    if (neighbor == null || neighbor instanceof WhiteNode)
      ...
      retval += neighbor.sumAdjacent(QuadrantFields.cNorthEast, QuadrantFields.cSouthEast, size);
